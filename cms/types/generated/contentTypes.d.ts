...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    heading: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Yenilik\u00E7i Teknoloji ve Tasar\u0131m Tutkusu'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    address: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Maslak, \u0130stanbul'>;
    contact_info_description: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Markan\u0131z\u0131 dijitalde parlatmak ve yenilik\u00E7i teknoloji \u00E7\u00F6z\u00FCmlerimizle tan\u0131\u015Fmak i\u00E7in ekibimizle do\u011Frudan ileti\u015Fime ge\u00E7in.'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'iletisim@macework.com'>;
    form_button_text: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Teklif Al'>;
    form_heading: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Yeni Bir Projeye Ba\u015Flayal\u0131m'>;
    form_interest_options: Schema.Attribute.JSON;
    form_placeholder_company: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Macework'>;
    form_placeholder_email: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'iletisim@macework.com'>;
    form_placeholder_message: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Projenizden veya talebinizden bahsedin...'>;
    form_placeholder_name: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Yaser K\u00F6se'>;
    form_subheading: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Fikrinizi \u00FCr\u00FCne d\u00F6n\u00FC\u015Ft\u00FCrmek veya markan\u0131z\u0131 dijitalde b\u00FCy\u00FCtmek i\u00E7in ilk ad\u0131m\u0131 at\u0131n.'>;
    heading: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u0130leti\u015Fime Ge\u00E7in'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    phone: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'+90 212 000 0000'>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    ...
    whatsapp_number: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'+905000000000'>;
    whatsapp_text: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<"H\u0131zl\u0131 cevap i\u00E7in WhatsApp'tan ula\u015F\u0131n.">;
  };
}
...
export interface ApiGlobalSettingGlobalSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    site_name: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Macework Creative'>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    platform_url: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
...
export interface ApiSolutionSolution extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cta_label: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Hizmet Hakk\u0131nda Bilgi Al'>;
