import { saveProjectsPageSettingsAction } from "@/actions/admin/content";
...
import { getProjectsPageSettings } from "@/lib/cms";

export default async function AdminProjectsPageSettings() {
  ...
  return (
    <>
      <PageBackLink />
      <AdminPageHeader
        title="Islerimiz Sayfasi"
        description="Ust alan ve alt proje baslatma CTA metinlerini yonetin."
      />

      <AdminActionForm
        action={saveProjectsPageSettingsAction}
        className="space-y-6"
        successMessage="Islerimiz sayfasi kaydedildi."
        trackDirty
      >
        ...
        <PageSaveBar label="Islerimiz sayfasini kaydet" />
      </AdminActionForm>
    </>
  );
}
